...
import (
	...
	"github.com/gkwa/braveside/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.braveside.yaml)")
